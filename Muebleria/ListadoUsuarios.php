...
echo "<br />";
	...
	if(isset($_SESSION['usuario'])){
		...
		$queri_result_tipo=mysqli_query($idconexion,$sql) or die ("error en el selec del tipo usuario"
		.mysqli_error($idconexion));
		$dato_tipo=mysqli_fetch_array($queri_result_tipo);
...
<?php
       require_once 'plan_footer.php';
		...
		echo "<script>alert('hola mundo')</script>";
			...
			echo "Este Area mantien Permisos Reserbados.....";
			echo "</div>";				
      		echo "</div>";
		}	
	}
